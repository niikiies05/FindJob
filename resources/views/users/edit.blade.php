        ...
        <div class="modal-content">
            <form action="{{ route('users.update', $user->id) }}" method="post">
                ...
                <div class="modal-header d-flex align-items-center bg-dark text-white">
                    <h6 class="modal-title mb-0" id="addUserLabel">{{ __('user.edit_page_title') }}</h6>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control @error('phone_number') is-invalid @enderror"
                                    id="userMobile" name="phone_number" value="{{ $user->mobile }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                    id="useremail" name="email" value="{{ $user->email }}" placeholder="{{ __('user.placeholder_email') }}">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control @error('password') is-invalid @enderror"
                                    id="password" name="password" placeholder="{{ __('user.user_password') }}">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                placeholder="About user (describe him)">{{ $user->about_yourself }}
                                </textarea>
                                @error('about')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" value="{{ __('button.update_button') }}" class="btn btn-primary">
                </div>
            </form>
        </div>
    </div>
